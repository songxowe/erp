...
<body bgcolor="#ccccff" >
	 <form action="<%=request.getContextPath() %>/zjsSgDetailsController_modifyCheckTag.do" id="b" method="post">
	...
	<label>出库详细理由:<input readonly="readonly" name="reasonexact" value="${sga.reasonexact}" style="border: hidden;" /></label>	
      ...
      <tr style="text-align: center;border: hidden">
    	...
    	<td bgcolor="#ffcc33"><input type="text" readonly="readonly" name="nowAmounta" style="border: hidden;background-color:#ffcc33;text-align: center;"  value="${sga.nowAmounta}"/></td>
	...
	<label>已出库总成本:<input readonly="readonly" name="realSalAlla" value="${sga.realSalAlla }" style="border: hidden;" /></label>	
		...
		<tr>
    <td colspan="3" style="border: hidden;"><label>复核人：<input  name="register" readonly="readonly" style=" border-top: thin;border-left:thin;border-right:thin;border-bottom-width:1  ;border-color: #000000; width: 287px" value="${sga.register}"/></label></td>
	<td colspan="3" style="border: hidden;">
