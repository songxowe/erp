...
<body bgcolor="#ebf3fb" oncontextmenu="event.returnValue=true"
	...
	<form
		action="<%=request.getContextPath() %>/manufactureController_addd.do?id=${manu.id}"
		method="post">
		<div class="DIV_STYLE2">
			<br /> <br /> &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
				id="checkTag1" value="0" name="checkTag" />通过 <input id="checkTag2"
				na type="radio" value="1" name="checkTag" />不通过 <input
				type="button" value="审核"
				onclick="checkon('${manu.manufactureId}',${manu.moduleCostPriceSum+manu.labourCostPriceSum})" />
			<br /> <br />
					...
					<tr>
						<td valign=bottom align=center class="TABLE_STYLE6" rowspan=2>
													...
													<td>
														...
														<table align=center class="TABLE_STYLE4">
															<tr height=20 class="TR_STYLE1">
																...
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%">${manu.manufactureId}</td>
															</tr>
															<tr height=20 class="TR_STYLE1">
																<td bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">产品编号：</td>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%">${manu.productId}</td>
																<td bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">产品名称：</td>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%">${manu.productName}</td>
															</tr>
															<tr>
																<td bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">数量：</td>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%">${manu.amount }</td>
																<td bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">工单制定人：</td>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%"><input type="text" name="designer"
																	value="${manu.designer }" readonly="readonly" /></td>
															</tr>
														</table>
														<table align=center class="TABLE_STYLE4">
															<tr height=20 class="TR_STYLE1">
														...
														<table bordercolor=#000000 bordercolorlight=#848284
															...
															<tr height=20 class="TR_STYLE1">
																...
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"></td>
																...
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2">
																	<a href="#"
																	onclick="manusee(${str.id },${manu.amount })">查看物料
																</a>
																</td>
															</tr>
															</c:forEach>
														...
														<TABLE align=center class="TABLE_STYLE4">
															<tr height=20 class="TR_STYLE1">
																<th bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">工时总成本：</th>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%">${manu.labourCostPriceSum}</td>
																<th bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">物料总成本：</th>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%"><input type="text"
																	value="${manu.moduleCostPriceSum}" readonly="readonly"></td>
															</tr>
															<tr height=20 class="TR_STYLE1">
																<th bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">登记人：</th>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%"><input type="text" name="register"
																	value="${manu.register}" readonly="readonly" /></td>
																<th bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">登记时间：</th>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%"><fmt:formatDate
																		pattern="yyyy-MM-dd HH:mm:ss"
																		value="${manu.registerTime}" /></td>
															</tr>
															<tr height=20 class="TR_STYLE1">
																<th bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">审核人：</th>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%"><input type="text" id="checker"
																	value="${NEWER_USER_LOGIN_INFO.username}"
																	readonly="readonly" /></td>
																<th bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">审核时间：</th>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%"><fmt:formatDate
																		pattern="yyyy-MM-dd HH:mm:ss"
																		value="${manu.checkTime}" /></td>
															</tr>
															<tr height=20 class="TR_STYLE1">
																<th bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">描述：</th>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%"></td>
																<th bordercolorlight=#848284 bordercolordark=#eeeeee
																	align=right class="TD_STYLE8" width="10%">出库单编号：</th>
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="40%"></td>
															</tr>
															<tr height=20 class="TR_STYLE1">
																...
																<td bordercolor=#DEDBD6 align=left class="TD_STYLE2"
																	width="89%" colspan="3"><textarea rows=4
																		class="TEXTAREA_STYLE1" id="remark"></textarea></td>
															</tr>
														</table>
													</td>
												</tr>
							...
							<div id="dis_see"></div> <script type="text/javascript">
								...
								function checkon(manufactureId, total) {
									var checkTag = "";
									...
									var checker = document
											.getElementById("checker").value;
									var remark = document
											.getElementById("remark").value;
									window.location.href = "dispatchController_check.do?manufactureId="
											+ manufactureId
											+ "&&checkTag="
											+ checkTag
											+ "&&checker="
