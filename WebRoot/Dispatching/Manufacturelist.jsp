	...
	<script type="text/javascript">
		$(function() {
			...
			$("#empDataGrid").datagrid(
					{
						url : "<%=request.getContextPath()%>/manufactureController.do",
								title : '制定生产派工单',
								...
								columns : [ [
										...
										},
										{
											...
											formatter : function(value,
												...
												var id = rowData["id"];
												return "<a href='#' onclick=getMenu1('"
														+ productId+"','" + id+ "')>审核</a>";
											}
										} ] ], // -- 列结束 ---------
		...
		function getMenu1(productId,id) {
		var href = "<%=request.getContextPath() %>/dispatchController_checkpage.do?productId=" + productId + "&id="
				+ id;
