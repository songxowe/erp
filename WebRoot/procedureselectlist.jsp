	...
	<body>
		<div style="margin: 10px 30px;">
			...
			<a href="#" class="easyui-linkbutton" iconCls="icon-edit"
				onclick="user_obj.showEdit('edit')">查看详细</a>&nbsp;&nbsp;
	...
	$(function() {
		user_obj = {
					...
					$.messager.confirm("消息","确认真的要删除所选的数据吗",function(flag){
						if(flag){
							...
							$.ajax({
								...
								beforeSend : function(){
									$("#userDataGrid2").datagrid("loading");
								},
								success : function(data){
									if(data) {
										$("#userDataGrid2").datagrid("loaded");
										$("#userDataGrid2").datagrid("load");
										$("#userDataGrid2").datagrid("unselectAll");
										$.messager.show({
											title : "提示",
											msg : data + "个用户被删除"
										});
			...
			showEdit : function(state){
				var url = "mdesignProcedure_query.do";
				var info = "";
				var id = 0;
				if(state == 'add') {//新增
					info = "新增用户信息";
