...
<body oncontextmenu="event.returnValue=true"
	...
	<form id="addform" action="" method="post">
		<div class="TABLE_STYLE4" align="center">
				<input type="radio" name="checkTag" value="不通过"
					checked="checked" />不通过 <input type="radio" name="checkTag"
					value="通过" />通过&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" value="确定 " class="easyui-linkbutton"
					onclick="addtoProcedure()">
