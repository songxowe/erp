...
责任人控制</a>）</td>
 ...
 <div style="display:block;position:absolute;left:950px;top:55px;">
...
<div  class="DIV_STYLE2" style="position:absolute;top:80px;left:60px;">
...
<TABLE bordercolor=#000000 bordercolorlight=#848284 bordercolordark=#eeeeee border=1 cellspacing=0 cellpadding=0 align=center class="TABLE_STYLE5">
 ...
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="8%">工序状态</td>
...
<c:forEach items="${mlist}" var="list">
	 ...
	 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2">${list.detailsNumber}&nbsp;</td>
 	 ...
 	 <c:if test="${list.procedureFinishTag=='G004-1'}">
 	 	已完成
 	 </c:if>
 	 <c:if test="${list.procedureFinishTag=='G004-2'||list.procedureFinishTag=='G004-3'}">
 	 	执行
 	 </c:if>
 	 </td>
 ...
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2"><a href="lbQueryController_labor.do?id=${manufacture.id}&&mid=${list.id}">${list.realSubtotal}&nbsp;</a></td>
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2">${list.moduleSubtotal}&nbsp;</td>
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2"><a href="lbQueryController_material.do?id=${manufacture.id}&&mid=${list.id}">${list.realModuleSubtotal}&nbsp;</a></td>
</tr>
</c:forEach>
</table>
<table align=center class="TABLE_STYLE4">
