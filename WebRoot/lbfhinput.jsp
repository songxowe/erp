...
<tr height=20 class="TR_STYLE1">
<td bgcolor=#D2E9FF bordercolorlight=#000000 bordercolordark=#000000 align=left height=20 class="TD_STYLE1" width="30%">本工序投产数量&nbsp;</td> 
<td valign=top bgcolor=#eeeeee bordercolor=#000000 class="TD_STYLE2" width="70%"><input type="text"  class="INPUT_STYLE1" id="aa" style="width: 30%" value="${AAA}" readonly="readonly"></td>
</tr>
<tr>
...
<td valign=top bgcolor=#eeeeee bordercolor=#000000 class="TD_STYLE2" width="70%"><input type="text"  class="INPUT_STYLE1" id="aaa" style="width: 30%" value="${BBB}"></td>
</tr>
</table>
</div>
</div></div></div>
