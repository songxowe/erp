	...
	<script type="text/javascript">
			...
			$("#auDateGrid").datagrid(
					{
						...
						onAfterEdit : function(rowIndex, rowData, changes) {
							...
							// 从上一次的提交获取改变的所有行
							var inserted = $("#auDateGrid").datagrid(
									"getChanges", "inserted");
							var updated = $("#auDateGrid").datagrid(
									"getChanges", "updated");
							...
							$.ajax({
								...
								type : "post",
								data : {
									"designId" : rowData.designId,
									"productId" : rowData.productId,
									"productName" : rowData.productName,
									"designer" : rowData.designer,
									"registerTime" : rowData.registerTime,
									"costPriceSum" : rowData.costPriceSum
								},
								beforeSend : function() {
									// 显示载入状态
									$("#auDateGrid").datagrid("loading");
								},
								success : function(data) {
									if (data) {
										// 隐藏载入状态
										$("#auDateGrid").datagrid("loaded");
										// 加载和显示第一页的所有行
										$("#auDateGrid").datagrid("load");
										// 取消选择所有当前页中所有的行
										$("#auDateGrid")
		...
		function getMenu(designId) {
			$("#ediMenu").window({
				...
				href : "goAudits.do?designId=" + designId
			});
		}
	</script>
</body>
