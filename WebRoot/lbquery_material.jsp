...
<table align=center class="TABLE_STYLE4">
 ...
 <tr height=20 class="TR_STYLE1">
 <td bordercolorlight=#848284 bordercolordark=#eeeeee align=right class="TD_STYLE8" width="13%">实际物料成本：</td>
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="37%">${mprocedure.realModuleSubtotal}&nbsp;</td>
	 <td bordercolorlight=#848284 bordercolordark=#eeeeee align=right class="TD_STYLE8" width="13%">&nbsp; </td>
	 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="37%">&nbsp;</td>
	</tr>
</table>
<table align=center class="TABLE_STYLE4">
 <tr height=20 class="TR_STYLE1">
...
<TABLE bordercolor=#000000 bordercolorlight=#848284 bordercolordark=#eeeeee border=1 cellspacing=0 cellpadding=0 align=center class="TABLE_STYLE5">
 ...
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="8%">物料名称</td>
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="13%">物料编号</td>
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="8%">本次数量 </td>
	 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="11%">单位物料成本</td>
	 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="11%">物料成本（元）</td>
...
<c:forEach items="${mplist}" var="list" >
 ...
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2">${list.productId }</td>
	 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2">${list.amount }&nbsp;</td>
	 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2">${list.costPrice }&nbsp;</td>
