...
<script type="text/javascript">  
     ...
     function openSubWin()  
     {  
         OpenWindow = window.open('procedure.jsp', 'newwindow', 'height=550, width=1300, toolbar=no, menubar=yes, scrollbars=yes,resizable=yes,location=no, status=no');  
     }  
...
<form id="mutiValidation" action="mpd_save.do"  method="POST" name="form1">
 <input type="button" id="btn1" value="添加产品工序" onclick="openSubWin()"/>
 <input type="button" id="btn2" value="删除产品工序" onclick="delSelect()"/>
 <input type="submit" value="提交" onclick="tabsClose()"/>
...
<tr height=20 class="TR_STYLE1">
 ...
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="40%"><input name="productName" type="hidden" value="${designModule.productName }">${designModule.productName }</td>
 <td bordercolorlight=#848284 bordercolordark=#eeeeee align=right class="TD_STYLE8" width="9%">产品编号：</td>
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="40%"><input name="did" type="hidden" value="${designModule.id }"><input name="productId" type="hidden" value="${designModule.productId }">${designModule.productId }</td>
...
<tr height=20 class="TR_STYLE1">
 ...
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" colspan="3" width="89%"><input type="text"  class="INPUT_STYLE3" name="designer" type="text" value="${NEWER_USER_LOGIN_INFO.username}" style="width:44.8%"></td>
</tr>
</table>
<table align=center class="TABLE_STYLE4">
 <tr height=20 class="TR_STYLE1">
...
<thead>
 ...
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="5%">点选</td>
...
<tr height=20 class="TR_STYLE1">
 ...
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="40%"><input type="text"  class="INPUT_STYLE3" name="register" type="text" value="${NEWER_USER_LOGIN_INFO.username}" readonly="readonly"></td>
 <td bordercolorlight=#848284 bordercolordark=#eeeeee align=right class="TD_STYLE8" width="9%">登记时间：</td>
 <td bordercolor=#DEDBD6 align=left class="TD_STYLE2" width="40%"><input name="registerTime" type="hidden"><%=today%></td>
 </tr>
<tr height=20 class="TR_STYLE1">
