...
<%
    ...
    %>
<form id="mutiValidation" action="mpd_modfiy.do"  method="POST" name="form1">
 <input type="radio" value="1" name="checkid" checked="checked"/>通过
 <input type="radio" value="2" name="checkid"/>不通过
 <input type="submit" value="提交" onclick="closeAll()"/>
