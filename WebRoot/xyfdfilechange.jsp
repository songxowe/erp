...
<form action="xyfDfileController_changed.do">
<input type="hidden" name="id" value="${id}">
<table  class="TABLE_STYLE2">

 <tr height=20 class="TR_STYLE1">
 <td  class="TD_HANDBOOK_STYLE1">您正在做的业务是：产品设计--产品档案管理--产品档案变更</td>
 </tr>
 <tr height=20 class="TR_STYLE1">
 <td  class="TD_STYLE3">
 <div  class="DIV_STYLE1">
 <input type="submit" value="提交" />&nbsp&nbsp<input type="button" value="返回" onclick="window.location='xyfdfilechangelist.jsp'"/>
 </div>
 </td>
 </tr>
</table>
...
<tr height=20 class="TR_STYLE1">
 ...
 <td valign=top bgcolor=#eeeeee bordercolor=#000000 class="TD_STYLE2" width="37.4%"><input type="hidden"  class="INPUT_STYLE1" name="productName" style="width:80%" value="${dfile.productName }">${dfile.productName }</td>
...
<tr height=20 class="TR_STYLE1">
 ...
 <td valign=top bgcolor=#eeeeee bordercolor=#000000 class="TD_STYLE2" width="13%">
 <input type="hidden"  class="INPUT_STYLE1" name="type" style="width:80%" value="${dfile.type }">
 	<c:if test="${dfile.type=='Y001-1' }">商品</c:if> 
 	<c:if test="${dfile.type=='Y001-2' }">物料</c:if> 
...
<td bgcolor=#D2E9FF bordercolorlight=#000000 bordercolordark=#000000 align=right class="TD_STYLE1" width="11%">计量单位</td>
 ...
 <td valign=top bgcolor=#eeeeee bordercolor=#000000 class="TD_STYLE2" width="13%"><input type="hidden"  class="INPUT_STYLE1" name="listPrice" style="width:49%" value="${dfile.listPrice }">${dfile.listPrice }</td>
 <td bgcolor=#D2E9FF bordercolorlight=#000000 bordercolordark=#000000 align=right class="TD_STYLE1" width="11%">计划成本单价 </td>
 <td valign=top bgcolor=#eeeeee bordercolor=#000000 class="TD_STYLE2" width="13%"><input type="hidden"  class="INPUT_STYLE1" name="costPrice" style="width:49%" value="${dfile.costPrice }">${dfile.costPrice }</td>
 </tr>
...
<tr height=20 class="TR_STYLE1">
 ...
 <td valign=top bgcolor=#eeeeee bordercolor=#000000 class="TD_STYLE2" width="13%"><input type="text"  class="INPUT_STYLE1" name="changer" style="width:49%" value="" readonly="readonly"></td>
