...
<form id="myform" name="myform" action="xyfDfileController_delete.do?id=${param.id }" method="post">
	<table  class="TABLE_STYLE2">
 <tr height=20 class="TR_STYLE1">
 <td  class="TD_HANDBOOK_STYLE1">您正在做的业务是：产品设计--产品档案管理--产品档案删除管理--产品档案删除</td>
 </tr>
 <tr height=20 class="TR_STYLE1">
 <td  class="TD_STYLE3">您确认要删除这例档案吗？</td>
...
<script type="text/javascript">
	function Done(){
		location.href="xyfdfiledelete.jsp";
	}
</script>
</body>
</html>